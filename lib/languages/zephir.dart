...
final zephir = Mode(
    refs: {
      '~contains~6~contains~1~contains~3': Mode(variants: [BINARY_NUMBER_MODE, C_NUMBER_MODE]),
    ...
    contains: [
      ...
      Mode(
          ...
          lexemes: "[a-zA-Z_]\\w*"),
      Mode(className: "string", begin: "<<<['\"]?\\w+['\"]?\$", end: "^\\w+;", contains: [BACKSLASH_ESCAPE]),
      ...
      Mode(className: "function", beginKeywords: "function", end: "[;{]", excludeEnd: true, illegal: "\\\$|\\[|%", contains: [
        ...
        Mode(className: "params", begin: "\\(", end: "\\)", contains: [Mode(self: true), C_BLOCK_COMMENT_MODE, Mode(ref: '~contains~6~contains~1~contains~2'), Mode(ref: '~contains~6~contains~1~contains~3')])
      ]),
