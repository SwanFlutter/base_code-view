...
final ini = Mode(
    refs: {
      ...
      '~contains~2~starts~contains~1~contains~3': Mode(
          ...
          variants: [Mode(begin: "'''", end: "'''", relevance: 10), Mode(begin: "\"\"\"", end: "\"\"\"", relevance: 10), Mode(begin: "\"", end: "\""), Mode(begin: "'", end: "'")]),
      ...
      '~contains~0':
          Mode(className: "comment", contains: [PHRASAL_WORDS_MODE, Mode(className: "doctag", begin: "(?:TODO|FIXME|NOTE|BUG|XXX):", relevance: 0)], variants: [Mode(begin: ";", end: "\$"), Mode(begin: "#", end: "\$")]),
    },
    aliases: ["toml"],
