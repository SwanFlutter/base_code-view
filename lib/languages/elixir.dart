...
final elixir = Mode(
    refs: {
      ...
      '~contains~0~contains~1~contains~7':
          Mode(className: "symbol", begin: ":(?![\\s:])", contains: [Mode(ref: '~contains~0'), Mode(begin: "[a-zA-Z_]\\w*[!?=]?|[-+\\x7e]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?")], relevance: 0),
      ...
      '~contains~0~contains~1~contains~12': Mode(
          ...
          contains: [
            HASH_COMMENT_MODE,
            Mode(className: "regexp", illegal: "\\n", contains: [BACKSLASH_ESCAPE, Mode(ref: '~contains~0~contains~1')], variants: [Mode(begin: "/", end: "/[a-z]*"), Mode(begin: "%r\\[", end: "\\][a-z]*")])
          ],
          relevance: 0),
      '~contains~0~contains~1~contains~11': Mode(begin: "->"),
      '~contains~0~contains~1~contains~10': Mode(className: "variable", begin: "(\\\$\\W)|((\\\$|\\@\\@?)(\\w+))"),
      '~contains~0~contains~1~contains~1': Mode(className: "string", begin: "\\x7e[A-Z](?=[/|([{<\"'])", contains: [
        Mode(begin: "\"", end: "\""),
        Mode(begin: "'", end: "'"),
        Mode(begin: "\\/", end: "\\/"),
        Mode(begin: "\\|", end: "\\|"),
