...
final stylus = Mode(
    ...
    contains: [
      ...
      Mode(className: "function", begin: "^[a-zA-Z][a-zA-Z0-9_-]*\\(.*\\)", illegal: "[\\n]", returnBegin: true, contains: [
        ...
        Mode(className: "params", begin: "\\(", end: "\\)", contains: [Mode(ref: '~contains~4'), Mode(ref: '~contains~10'), APOS_STRING_MODE, CSS_NUMBER_MODE, NUMBER_MODE, QUOTE_STRING_MODE])
      ]),
      Mode(
          className: "attribute",
          begin:
          ...
          starts: Mode(end: ";|\$", contains: [Mode(ref: '~contains~4'), Mode(ref: '~contains~10'), APOS_STRING_MODE, QUOTE_STRING_MODE, CSS_NUMBER_MODE, NUMBER_MODE, C_BLOCK_COMMENT_MODE], illegal: "\\.", relevance: 0))
    ]);
