...
final cos = Mode(
    ...
    contains: [
      ...
      Mode(begin: "&sql\\(", end: "\\)", excludeBegin: true, excludeEnd: true, subLanguage: [Languages.sql]),
      Mode(begin: "&(js|jscript|javascript)<", end: ">", excludeBegin: true, excludeEnd: true, subLanguage: [Languages.javascript]),
      Mode(begin: "&html<\\s*<", end: ">\\s*>", subLanguage: [Languages.xml])
    ]);
