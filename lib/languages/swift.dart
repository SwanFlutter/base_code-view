...
final swift = Mode(refs: {
  '~contains~2': Mode(className: "comment", begin: "/\\*", end: "\\*/", contains: [Mode(self: true), PHRASAL_WORDS_MODE, Mode(className: "doctag", begin: "(?:TODO|FIXME|NOTE|BUG|XXX):", relevance: 0)]),
  ...
  Mode(
      ...
      contains: [
        ...
        Mode(
            ...
            contains: [Mode(self: true), Mode(ref: '~contains~0~contains~1~contains~0'), Mode(ref: '~contains~0'), C_BLOCK_COMMENT_MODE, Mode(begin: ":")],
            illegal: "[\"']")
      ],
      illegal: "\\[|%"),
  Mode(
  ...
  Mode(beginKeywords: "import", end: "\$", contains: [C_LINE_COMMENT_MODE, Mode(ref: '~contains~2')])
]);
