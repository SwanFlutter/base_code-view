...
final ruby = Mode(
    refs: {
      '~contains~3~starts~contains~0~contains~1~contains~3~contains~1~contains~9': Mode(className: "params", begin: "\\|", end: "\\|", keywords: {
        "keyword":
      ...
      '~contains~3~starts~contains~0~contains~1~contains~3~contains~1~contains~6': Mode(
          className: "symbol",
          begin: ":(?!\\s)",
          contains: [Mode(ref: '~contains~3~starts~contains~0'), Mode(begin: "[a-zA-Z_]\\w*[!?=]?|[-+\\x7e]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?")],
          relevance: 0),
      ...
      '~contains~3~starts~contains~0~contains~1~contains~3~contains~1~contains~10': Mode(
          ...
          contains: [
            ...
            Mode(
                className: "regexp",
                contains: [BACKSLASH_ESCAPE, Mode(ref: '~contains~3~starts~contains~0~contains~1')],
                illegal: "\\n",
      ...
      '~contains~3~starts~contains~0': Mode(className: "string", contains: [
        ...
        Mode(begin: "<<[-\\x7e]?'?(\\w+)(?:.|\\n)*?\\n\\s*\\1\\b", returnBegin: true, contains: [
          Mode(begin: "<<[-\\x7e]?'?"),
          Mode(begin: "\\w+", endSameAsBegin: true, contains: [BACKSLASH_ESCAPE, Mode(ref: '~contains~3~starts~contains~0~contains~1')])
        ])
      ]),
      ...
      '~contains~1': Mode(
          ...
          contains: [Mode(ref: '~contains~0~contains~0'), PHRASAL_WORDS_MODE, Mode(className: "doctag", begin: "(?:TODO|FIXME|NOTE|BUG|XXX):", relevance: 0)],
          relevance: 10),
      '~contains~0~contains~0': Mode(className: "doctag", begin: "@[A-Za-z]+"),
      '~contains~0': Mode(className: "comment", begin: "#", end: "\$", contains: [Mode(ref: '~contains~0~contains~0'), PHRASAL_WORDS_MODE, Mode(className: "doctag", begin: "(?:TODO|FIXME|NOTE|BUG|XXX):", relevance: 0)]),
    },
