...
final twig = Mode(
    refs: {
      '~contains~1~contains~0~starts~contains~0~contains~0': Mode(
          ...
          keywords: {"name": "attribute block constant cycle date dump include max min parent random range source template_from_string"},
          relevance: 0,
    ...
    contains: [
      ...
      Mode(
          className: "template-variable", begin: "\\{\\{", end: "}}", contains: [Mode(self: true), Mode(ref: '~contains~1~contains~0~starts~contains~0'), Mode(ref: '~contains~1~contains~0~starts~contains~0~contains~0')])
    ]);
