...
final css = Mode(
    ...
    contains: [
      ...
      Mode(className: "selector-attr", begin: "\\[", end: "\\]", illegal: "\$", contains: [APOS_STRING_MODE, QUOTE_STRING_MODE]),
      ...
      Mode(begin: "@", end: "[{;]", illegal: ":", returnBegin: true, contains: [
        ...
        Mode(
            ...
            contains: [Mode(begin: "[a-z-]+:", className: "attribute"), APOS_STRING_MODE, QUOTE_STRING_MODE, CSS_NUMBER_MODE])
      ]),
          ...
          Mode(
              ...
              starts: Mode(endsWithParent: true, excludeEnd: true, contains: [
                Mode(begin: "[\\w-]+\\(", returnBegin: true, contains: [
                  ...
                  Mode(begin: "\\(", end: "\\)", contains: [APOS_STRING_MODE, QUOTE_STRING_MODE, CSS_NUMBER_MODE])
                ]),
                CSS_NUMBER_MODE,
                QUOTE_STRING_MODE,
                APOS_STRING_MODE,
