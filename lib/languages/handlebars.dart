...
final handlebars = Mode(
    refs: {
      '~contains~7~contains~0': Mode(
          begin: "\".*?\"|'.*?'|\\[.*?\\]|\\w+",
          keywords: {"builtin-name": "each in with if else unless bindattr action collection debugger log outlet template unbound view yield lookup"},
    ...
    contains: [
      ...
      Mode(
          ...
          starts: Mode(end: "\\{\\{\\{\\{\\/", returnEnd: true, subLanguage: [Languages.xml])),
