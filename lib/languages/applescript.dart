...
final applescript = Mode(refs: {
  '~contains~6': Mode(className: "comment", begin: "--", end: "\$", contains: [PHRASAL_WORDS_MODE, Mode(className: "doctag", begin: "(?:TODO|FIXME|NOTE|BUG|XXX):", relevance: 0)]),
  '~contains~0': Mode(className: "string", begin: "\"", end: "\"", illegal: "", contains: [BACKSLASH_ESCAPE]),
}, aliases: [
  "osascript"
], keywords: {
  "keyword":
  ...
  Mode(beginKeywords: "on", illegal: "[\${=;\\n]", contains: [
    ...
    Mode(className: "params", begin: "\\(", end: "\\)", contains: [Mode(self: true), C_NUMBER_MODE, Mode(ref: '~contains~0')])
  ]),
  Mode(ref: '~contains~6'),
  Mode(className: "comment", begin: "\\(\\*", end: "\\*\\)", contains: [Mode(self: true), Mode(ref: '~contains~6'), PHRASAL_WORDS_MODE, Mode(className: "doctag", begin: "(?:TODO|FIXME|NOTE|BUG|XXX):", relevance: 0)]),
  HASH_COMMENT_MODE
], illegal: "//|->|=>|\\[\\[");
