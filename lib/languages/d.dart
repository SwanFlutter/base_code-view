...
final d = Mode(
    ...
    contains: [
      ...
      Mode(className: "comment", begin: "\\/\\+", end: "\\+\\/", contains: [Mode(self: true), PHRASAL_WORDS_MODE, Mode(className: "doctag", begin: "(?:TODO|FIXME|NOTE|BUG|XXX):", relevance: 0)], relevance: 10),
