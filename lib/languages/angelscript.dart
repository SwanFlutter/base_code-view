...
final angelscript = Mode(
    refs: {
      ...
      '~contains~7':
          Mode(className: "built_in", begin: "\\b(void|bool|int|int8|int16|int32|int64|uint|uint8|uint16|uint32|uint64|string|ref|array|double|float|auto|dictionary)", contains: [Mode(ref: '~contains~7~contains~0')]),
    },
    aliases: ["asc"],
    keywords:
