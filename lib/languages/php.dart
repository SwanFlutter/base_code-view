...
final php = Mode(
    refs: {
      '~contains~9~contains~1~contains~4': Mode(variants: [BINARY_NUMBER_MODE, C_NUMBER_MODE]),
    ...
    contains: [
      HASH_COMMENT_MODE,
      Mode(className: "comment", begin: "//", end: "\$", contains: [Mode(ref: '~contains~1~contains~0'), PHRASAL_WORDS_MODE, Mode(className: "doctag", begin: "(?:TODO|FIXME|NOTE|BUG|XXX):", relevance: 0)]),
      Mode(
          className: "comment", begin: "/\\*", end: "\\*/", contains: [Mode(className: "doctag", begin: "@[A-Za-z]+"), PHRASAL_WORDS_MODE, Mode(className: "doctag", begin: "(?:TODO|FIXME|NOTE|BUG|XXX):", relevance: 0)]),
      Mode(
          className: "comment",
      ...
      Mode(className: "function", beginKeywords: "function", end: "[;{]", excludeEnd: true, illegal: "\\\$|\\[|%", contains: [
        ...
        Mode(
            ...
            contains: [Mode(self: true), Mode(ref: '~contains~7'), C_BLOCK_COMMENT_MODE, Mode(ref: '~contains~9~contains~1~contains~3'), Mode(ref: '~contains~9~contains~1~contains~4')])
      ]),
      ...
      Mode(beginKeywords: "namespace", end: ";", illegal: "[\\.']", contains: [UNDERSCORE_TITLE_MODE]),
