...
final actionscript = Mode(refs: {}, aliases: [
  ...
  C_NUMBER_MODE,
  Mode(className: "class", beginKeywords: "package", end: "{", contains: [TITLE_MODE]),
  Mode(className: "class", beginKeywords: "class interface", end: "{", excludeEnd: true, contains: [Mode(beginKeywords: "extends implements"), TITLE_MODE]),
  ...
  Mode(className: "function", beginKeywords: "function", end: "[{;]", excludeEnd: true, illegal: "\\S", contains: [
    ...
    Mode(
        ...
        contains: [APOS_STRING_MODE, QUOTE_STRING_MODE, C_LINE_COMMENT_MODE, C_BLOCK_COMMENT_MODE, Mode(className: "rest_arg", begin: "[.]{3}", end: "[a-zA-Z_\$][a-zA-Z0-9_\$]*", relevance: 10)]),
