...
final monkey = Mode(
    ...
    illegal: "\\/\\*",
    contains: [
      Mode(className: "comment", begin: "#rem", end: "#end", contains: [PHRASAL_WORDS_MODE, Mode(className: "doctag", begin: "(?:TODO|FIXME|NOTE|BUG|XXX):", relevance: 0)]),
      ...
      Mode(className: "class", beginKeywords: "class interface", end: "\$", contains: [Mode(beginKeywords: "extends implements"), UNDERSCORE_TITLE_MODE]),
      ...
      QUOTE_STRING_MODE,
      Mode(className: "number", relevance: 0, variants: [Mode(begin: "[\$][a-fA-F0-9]+"), NUMBER_MODE])
    ]);
