...
final dos = Mode(
    refs: {
      '~contains~1~contains~1':
          Mode(className: "comment", begin: "^\\s*@?rem\\b", end: "\$", contains: [PHRASAL_WORDS_MODE, Mode(className: "doctag", begin: "(?:TODO|FIXME|NOTE|BUG|XXX):", relevance: 0)], relevance: 10),
    },
    aliases: ["bat", "cmd"],
    ...
    contains: [
      ...
      Mode(
          ...
          contains: [Mode(className: "title", begin: "([_a-zA-Z]\\w*\\.)*([_a-zA-Z]\\w*:)?[_a-zA-Z]\\w*", relevance: 0), Mode(ref: '~contains~1~contains~1')]),
