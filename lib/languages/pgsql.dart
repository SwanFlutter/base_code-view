...
final pgsql = Mode(
    ...
    contains: [
      ...
      Mode(begin: "\\b(XMLELEMENT|XMLPI)\\s*\\(\\s*NAME", keywords: {"keyword": "NAME"}),
      Mode(begin: "\\b(XMLPARSE|XMLSERIALIZE)\\s*\\(\\s*(DOCUMENT|CONTENT)", keywords: {"keyword": "DOCUMENT CONTENT"}),
      Mode(beginKeywords: "CACHE INCREMENT MAXVALUE MINVALUE", end: "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", returnEnd: true, keywords: "BY CACHE INCREMENT MAXVALUE MINVALUE"),
      Mode(className: "type", begin: "\\b(WITH|WITHOUT)\\s+TIME\\s+ZONE\\b"),
      Mode(className: "type", begin: "\\bINTERVAL\\s+(YEAR|MONTH|DAY|HOUR|MINUTE|SECOND)(\\s+TO\\s+(MONTH|HOUR|MINUTE|SECOND))?\\b"),
      Mode(
      ...
      Mode(className: "string", begin: "(e|E|u&|U&)'", end: "'", contains: [Mode(begin: "\\\\.")], relevance: 10),
      Mode(begin: "\\\$([a-zA-Z_]?|[a-zA-Z_][a-zA-Z_0-9]*)\\\$", endSameAsBegin: true, contains: [
        Mode(subLanguage: [
          Languages.pgsql,
          Languages.perl,
          Languages.python,
      ...
      Mode(className: "meta", variants: [Mode(begin: "%(ROW)?TYPE", relevance: 10), Mode(begin: "\\\$\\d+"), Mode(begin: "^#\\w", end: "\$")]),
      Mode(className: "symbol", begin: "<<\\s*[a-zA-Z_][a-zA-Z_0-9\$]*\\s*>>", relevance: 10)
    ]);
